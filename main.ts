...
app.post('/generate', async (req, res) => {
  ...
  try {
    ...
    const articles = [{
      ...
      "title": "Unleashing the Beast: The Corvette Z06 - The Best Sounding American Car",
    ...
    {
      "title": "Electrifying Power versus Legendary Performance: Lucid Air with 1,100HP Takes on the Tuned BMW M3 in a Drag Race",
